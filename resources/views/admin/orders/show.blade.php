                    ...
                    <tr>
                        ...
                        <td>
                            @if($item->discount_percentage > 0)
                                ...
                                <small>(-${{ number_format($item->discount_value, 2) }})</small>
                            @else
                                -
                            @endif
                        </td>
                    ...
                    <div class="summary-table">
                        <table class="total-table">
                            <tr>
                                ...
                                <td>${{ number_format($order->total_prices - $order->delivery_fee + $order->total_discounts, 2) }}</td>
                            </tr>
                            @if($order->total_discounts > 0)
                            <tr>
                                <td>{{ __('messages.discount') }}:</td>
                                <td class="discount">-${{ number_format($order->total_discounts, 2) }}</td>
                            </tr>
                            @endif
                            <tr>
                            ...
                            <tr class="total-row">
                                ...
                                <td><strong>${{ number_format($order->total_prices, 2) }}</strong></td>
                            </tr>
                        </table>
                    </div>
                </div>
