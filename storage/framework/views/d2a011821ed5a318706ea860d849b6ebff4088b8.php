      ...
      <li class="nav-item dropdown" id="notif-dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="notif-menu"
          ...
          <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom">
            <strong><?php echo e(__('messages.notifications')); ?></strong>
            <a href="#" id="notif-mark-all" class="text-sm text-muted"><?php echo e(__('messages.Mark All Read')); ?></a>
          </div>
          <div id="notif-list">
            <span class="dropdown-item text-muted text-center py-3"><?php echo e(__('messages.No_data')); ?></span>
          </div>
        </div>
      </li>
    </ul>
...
(function () {
    ...
    var NOTIF_INDEX_URL  = '<?php echo e(route("admin.notifications.index")); ?>';
    var NOTIF_STREAM_URL = '<?php echo e(route("admin.notifications.stream")); ?>';
    var NOTIF_MARK_ALL   = '<?php echo e(route("admin.notifications.mark-all-read")); ?>';
    var CSRF             = '<?php echo e(csrf_token()); ?>';
    var BASE_ORDERS_URL  = '<?php echo e(url("")); ?>/<?php echo e(LaravelLocalization::getCurrentLocale()); ?>/admin/orders/';
    ...
    $(document).ready(function () {
        ...
        $('#notif-list').on('click', '.notif-item', function () {
            ...
            $.post(
                '<?php echo e(url("")); ?>/<?php echo e(LaravelLocalization::getCurrentLocale()); ?>/admin/notifications/' + id + '/mark-read',
                { _token: CSRF }
            );
...
<?php /**PATH C:\xampp\htdocs\game\resources\views/admin/includes/navbar.blade.php ENDPATH**/ ?>