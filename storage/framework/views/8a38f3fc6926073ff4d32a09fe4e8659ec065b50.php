            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="delivery-info">
                        ...
                        <p><strong><?php echo e(__('messages.delivery_place')); ?>:</strong> <?php echo e($order->delivery->place); ?> <br><?php echo e($order->address); ?></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\game\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>