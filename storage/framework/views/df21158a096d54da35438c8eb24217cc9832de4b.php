                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($item->discount_percentage > 0): ?>
                                ...
                                <small>(-$<?php echo e(number_format($item->discount_value, 2)); ?>)</small>
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
                    ...
                    <div class="summary-table">
                        <table class="total-table">
                            <tr>
                                ...
                                <td>$<?php echo e(number_format($order->total_prices - $order->delivery_fee + $order->total_discounts, 2)); ?></td>
                            </tr>
                            <?php if($order->total_discounts > 0): ?>
                            <tr>
                                <td><?php echo e(__('messages.discount')); ?>:</td>
                                <td class="discount">-$<?php echo e(number_format($order->total_discounts, 2)); ?></td>
                            </tr>
                            <?php endif; ?>
                            <tr>
                            ...
                            <tr class="total-row">
                                ...
                                <td><strong>$<?php echo e(number_format($order->total_prices, 2)); ?></strong></td>
                            </tr>
                        </table>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\game\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>